...
public class PipeUI extends javax.swing.JFrame {
    ...
    private void btnOrderActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnOrderActionPerformed
        ...
        if (getInputs() && validInput()){
            ...
            if (type != 0) {  
                ...
                cost = new DecimalFormat("0.00").
                        format(newOrder.getOrderPrice());

                //Yes or no option message box if theyd like to add to order
                JDialog.setDefaultLookAndFeelDecorated(true);
                int response = JOptionPane.showConfirmDialog(null, 
                        "You require a type " + type + ". This pipe costs £"
                        + cost + ". Would you like to add to order?",
                        "Add to order",
       ...
       //displays image in message box
        try {
            BufferedImage myPicture = 
                    ImageIO.read(new File("JavaCW-Tables.png"));
    ...
    private boolean rangeCheck(String name, double testValue, 
    ...
    private void initPipe(int type) {
        ...
        switch (type) {
            case 1:
                aPipe = new Pipe1(newLength, newRadius, newGrade, 
                        chemicalResist);
                break;
            case 2:
                aPipe = new Pipe2(newLength, newRadius, newGrade, 
                        chemicalResist);
                break;
            case 3:
                aPipe = new Pipe3(newLength, newRadius, newGrade, 
                        chemicalResist);
                break;
            case 4:
                aPipe = new Pipe4(newLength, newRadius, newGrade, 
                        chemicalResist);
                break;
            case 5:
                aPipe = new Pipe5(newLength, newRadius, newGrade, 
                        chemicalResist);
                break;
        }
    }
